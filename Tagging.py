...
"""
COLORSSPACE = {'key':'colorspace','options_gui':[('RGB','RGB'),('CIE Lab', 'Lab'),('11 basic colors','ColorNaming'),('HSV','hsv')]}
FITTING = {'key':'fitting','options_gui':[('None','None'),('Fisher', 'Fisher'),('Silhouette', 'Silhouette')]}
CENTROIDSINIT = {'key':'km_init','options_gui':[('First points','first'),('Randomize', 'random'),('Diagonal','diagonal')]}
SIMILARITY = {'key':'metric','options_gui':[('Basic','basic'),('Complete','complete'),('SOF','sof')]}
...
class Tagging(Frame):
    ...
    def __init__(self, parent, options):
        if options == None:
            options = {}            
        DefaultOptions = {'colorspace':'RGB', 'K':2, 'km_init':'first', 'verbose':False, 
                          'single_thr':0.6, 'metric':'basic', 'max_iter': 50}
...
def main():
    ...
    options = {'colorspace':'RGB', 'K':6, 'km_init':'first', 'verbose':False, 
               'single_thr':0.6, 'metric':'basic', 'fitting':'None', 'max_iter': 100}
